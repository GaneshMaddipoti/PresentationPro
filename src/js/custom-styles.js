function textStyle() {
    return [
        { margin: 10, width: 100, textAlign: "center", font: '500 18px Cursive, sans-serif', stroke: "#cccccc"}
    ];
}

function textStyle150() {
    return [
        { margin: 10, width: 150, textAlign: "center", font: '500 18px Cursive, sans-serif', stroke: "#cccccc"}
    ];
}
